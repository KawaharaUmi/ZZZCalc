...
class agentClass {
    ...
    total = {
        _root: this,
        get hp() {
            return Math.floor(this._root.base.hp * (100 + this._root.equipment.wEngine.advSt['hp-p'] + this._root.equipment.discTotal['hp-p']) / 100) + this._root.equipment.discTotal['hp-v']
        },
        get atk() {
            return Math.floor((this._root.base.atk + this._root.equipment.wEngine.atk) * (100 + this._root.equipment.wEngine.advSt['atk-p'] + this._root.equipment.discTotal['atk-p']) / 100) + this._root.equipment.discTotal['atk-v']
        },
        get def() {
            return Math.floor(this._root.base.def * (100 + this._root.equipment.wEngine.advSt['def-p'] + this._root.equipment.discTotal['def-p']) / 100) + this._root.equipment.discTotal['def-v']
        },
        get imp() {
            return Math.floor(this._root.base.imp * (100 + this._root.equipment.wEngine.advSt['imp-p'] + this._root.equipment.discTotal['imp-p']) / 100)
        },
        get critR() {
            return this._root.base.critR + this._root.equipment.wEngine.advSt['crit-r'] + this._root.equipment.discTotal['crit-r']
        },
        get critD() {
            return this._root.base.critD + this._root.equipment.wEngine.advSt['crit-d'] + this._root.equipment.discTotal['crit-d']
        },
        get anmB() {
            return Math.floor(this._root.base.anmB * (100 + this._root.equipment.wEngine.advSt['anm-b'] + this._root.equipment.discTotal['anm-b']) / 100)
        },
        get anmP() {
            return this._root.base.anmP + this._root.equipment.wEngine.advSt['anm-p'] + this._root.equipment.discTotal['anm-p']
        },
        get penR() {
            return this._root.base.penR + this._root.equipment.wEngine.advSt['pen-r'] + this._root.equipment.discTotal['pen-r']
        },
        get penV() {
            return this._root.equipment.wEngine.advSt['pen-v'] + this._root.equipment.discTotal['pen-v']
        },
        get enReg() {
            return Math.floor(this._root.base.enReg * 10 * (100 + this._root.equipment.wEngine.advSt['en-reg'] + this._root.equipment.discTotal['en-reg']) / 100) / 10
        },
        get bonusPhy() {
            return this._root.equipment.wEngine.advSt['bonus-phy'] + this._root.equipment.discTotal['bonus-phy']
        },
        get bonusFire() {
            return this._root.equipment.wEngine.advSt['bonus-fire'] + this._root.equipment.discTotal['bonus-fire']
        },
        get bonusIce() {
            return this._root.equipment.wEngine.advSt['bonus-ice'] + this._root.equipment.discTotal['bonus-ice']
        },
        get bonusEle() {
            return this._root.equipment.wEngine.advSt['bonus-ele'] + this._root.equipment.discTotal['bonus-ele']
        },
        get bonusEth() {
            return this._root.equipment.wEngine.advSt['bonus-eth'] + this._root.equipment.discTotal['bonus-eth']
        },
        get bonusDmg() {
            return this._root.equipment.wEngine.advSt['bonus-dmg']
        }
/*
        hp: 0,
        atk: 0,
    ...
    setSkillData() {
        for(const val of define.skillType) {
            ...
            for(const skillData of groupArray) {
                ...
                for(const data of result.params) {
                    const damage = {
                        calcurator: this.calcDmg,
                        total: this.total,
                        skills: this.skills,
